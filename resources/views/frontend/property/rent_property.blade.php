...
@section('title', 'Sell Property | EMPO RealEstate')
@section('main')
                    ...
                    <div class="default-sidebar property-sidebar">
                        ...
                        <div class="category-widget sidebar-widget">
                            <div class="widget-title">
                                <h5>Choose Property Type (Sell)</h5>
                            </div>
                            <ul class="category-list clearfix">
                                @foreach ($propertyTypes as $type)
                                    @php
                                        $count = $type->properties()->where('property_status', 'sell')->count();
                                    @endphp
                                    <li>
                                        <a href="{{ route('sell.property.plot.flat', $type->id) }}">
                                            Sell {{ $type->type_name }}
                                            <span>({{ $count }})</span>
                                        </a>
                                    </li>
                    ...
                    <div class="property-content-side">
                        <div class="item-shorting clearfix">
                            ...
                            <div class="left-column pull-right">
                                <h5>Total Sell Property: <span>{{ $totalSellProperties }}</span></h5>
                            </div>
                        </div>
                                                ...
                                                <a href="{{ url('property/details/' . $item->property_slug) }}">
                                                    <figure class="image">
                                                        <img src="{{ asset($item->property_thambnail) }}"
                                                            alt="property image" style="width: 500px; height: 350px;">
                                                    </figure>
                                                </a>
                                                ...
                                                <div class="price-box clearfix">
                                                    ...
                                                    <div class="author-box pull-right">
                                                        <figure class="author-thumb">
                                                            @if ($item->user)
                                                                <img src="{{ url('upload/agent_images/' . $item->user->photo) }}"
                                                                    alt="">
