                    ...
                    <div class="left-column pull-left clearfix">
                        ...
                        <div class="author-info clearfix">
                            <div class="author-box pull-left">
                                ...
                                <figure class="author-thumb"><img src="{{ url('upload/salman_sourov.png') }}" alt=""></figure>
                                                    <h6>Admin</h6>
                                                @else
                        ...
                        <div class="property-details-content">
                            ...
                            <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <a href="{{ asset('frontend')}}/assets/images/resource/statistics-1.png" class="lightbox-image" data-fancybox="gallery"><img src="{{ asset('frontend')}}/assets/images/resource/statistics-1.png" alt=""></a>
                                </figure>
                            </div>
                        ...
                        <div class="property-sidebar default-sidebar">
                            <div class="author-widget sidebar-widget">
                                <div class="author-box">
                                    <figure class="author-thumb"><img src="{{ asset('frontend')}}/assets/images/resource/author-1.jpg" alt=""></figure>
                                    <div class="inner">
                                        <h4>Michael Bean</h4>
                                        <ul class="info clearfix">
